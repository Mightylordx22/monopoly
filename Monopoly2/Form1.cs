...
namespace Monopoly2 {
    public partial class Form1 : Form {
        ...
        Dictionary<int, bool> playersInGame = new Dictionary<int, bool> { { 1, true }, { 2, true }, { 3, true }, { 4, true } };
        Dictionary<int, bool> inJail = new Dictionary<int, bool> { { 1, false }, { 2, false }, { 3, false }, { 4, false } };
        int endGame = 0;
        int currentPlayer = 1;
        int stevePos = 0;
        int alexPos = 0;
        int witherPos = 0;
        int edPos = 0;
        string[] boxes = new string[] { "pictureBox1", "pictureBox2", "pictureBox3", "pictureBox4", "pictureBox5", "pictureBox6", "pictureBox7", "pictureBox8", "pictureBox9", "pictureBox10", "pictureBox11", "pictureBox12", "pictureBox13", "pictureBox14", "pictureBox15", "pictureBox16", "pictureBox17", "pictureBox18", "pictureBox19", "pictureBox20", "pictureBox21", "pictureBox22", "pictureBox23", "pictureBox24", "pictureBox25", "pictureBox26", "pictureBox27", "pictureBox28", "pictureBox29", "pictureBox30", "pictureBox31", "pictureBox32", "pictureBox33", "pictureBox34", "pictureBox35", "pictureBox36", "pictureBox37", "pictureBox38", "pictureBox39", "pictureBox40" };
        ...
        public Form1() {
            ...
            steveMoneyLabel.Text = "$1500";
            alexMoneyLabel.Text = "$1500";
            witherMoneyLabel.Text = "$1500";
            edMoneyLabel.Text = "$1500";
        ...
        private void randomButton_Click(object sender, EventArgs e) {
            if (endGame == 3) {
                Dictionary<int, string> finalPlayers = new Dictionary<int, string> { { Int32.Parse(steveMoneyLabel.Text.Substring(1, steveMoneyLabel.Text.Length - 1)), "Steve" }, { Int32.Parse(alexMoneyLabel.Text.Substring(1, alexMoneyLabel.Text.Length - 1)), "Alex" }, { Int32.Parse(witherMoneyLabel.Text.Substring(1, witherMoneyLabel.Text.Length - 1)), "Wither" }, { Int32.Parse(edMoneyLabel.Text.Substring(1, edMoneyLabel.Text.Length - 1)), "Ender Dragon" } };
                int[] finalMoney = new int[] { Int32.Parse(steveMoneyLabel.Text.Substring(1, steveMoneyLabel.Text.Length - 1)), Int32.Parse(alexMoneyLabel.Text.Substring(1, alexMoneyLabel.Text.Length - 1)), Int32.Parse(witherMoneyLabel.Text.Substring(1, witherMoneyLabel.Text.Length - 1)), Int32.Parse(edMoneyLabel.Text.Substring(1, edMoneyLabel.Text.Length - 1)) };
                Array.Sort(finalMoney);
                Array.Reverse(finalMoney);
                for (int i = 0; i < finalMoney.Length; i++) {
                    Console.WriteLine(finalMoney[i]);
                }
                MessageBox.Show(String.Format("The game has now ended! Here are the results\n1] {0}\n2] {1}\n3] {2}\n4] {3}", finalPlayers[finalMoney[0]], finalPlayers[finalMoney[1]], finalPlayers[finalMoney[2]], finalPlayers[finalMoney[3]]));
            } else {
                ...
                if (currentPlayer == 1 && playersInGame[currentPlayer] is true) {
                    ...
                    if (steveMoney < 0) {
                        playersInGame[currentPlayer] = false;
                        label9.Text = "Out of game";
                        endGame += 1;
                    }
